...
FUNCTION XX_GET_DATE_VALUE (SQLS VARCHAR2) RETURN DATE;

FUNCTION XX_GET_NUMBER_VALUE (SQLS VARCHAR2) RETURN NUMBER;

FUNCTION XX_GET_STRING_VALUE (SQLS VARCHAR2) RETURN VARCHAR2;
