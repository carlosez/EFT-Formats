...
*/
    ...
    G_Doc_Ini           Number := 0;
    G_Doc_Fin           Number := 0;            /*-- IN CASE OF A RANGE OF PAYMENTS*/
    G_Checkrun_Id       Number := 0;            /* -- FOR PAYMENT BATCH*/
    G_All_Checks        Varchar2(10)   := '';    /* HETHER IS NEW OR ALL CHECKS*/
    G_Status_Check      Varchar(10)    := 'NEW';
...
*/
    ...
    F_FORMAT_TYPE       Varchar2(100);
    F_Delimiter         Varchar2(1);
...
--    V_Error_Code        Varchar2(10);
    ...
    W_File_Name         Varchar2(50)    := 'entrust_ctorres';
    W_File_Ext          Varchar2(4)     := '.txt';
    W_File_Dir          Varchar2(50);
